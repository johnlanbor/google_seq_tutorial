...
# ==============================================================================
#python -m nmt.nmt --src=vi --tgt=en --vocab_prefix=./tmp/nmt_data/vocab --train_prefix=./tmp/nmt_data/train --dev_prefix=.
#/tmp/nmt_data/tst2012 --test_prefix=./tmp/nmt_data/tst2013 --out_dir=./tmp/nmt_model --num_train_steps=12000 --steps_per_stats=100 --num_layers=2 --num_units=128 --dropout=0.2 --metrics=bleu
...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session=""):
  ...
  if flags.inference_input_file:
    ...
    # Train
    # 开始自训练过程 进入train.py  train函数
    train_fn(hparams, target_session=target_session)


def main(unused_argv):
  # 建立一些超参数，包括数据参数，训练参数等
